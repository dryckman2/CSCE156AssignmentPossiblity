...
/**
 * Takes subscription template and creates specific version to be inserted into
 * list of purchased
 * 
...
public class OrderedSubscription extends Subscription implements Purchased {
	...
	public void printReport() {
		...
		String formating = "\t(Subscription #" + this.getCode() + " " + this.getDaysLong() + "days at %"
				+ this.getBasePrice() + " per year)";
